        ...
        <header>
            <Container className="flex items-center justify-between h-[60px]">
                ...
                <div className="flex items-center gap-10">
                    <CustomInput 
                        classNameBox="bg-[#f6f7f9] rounded-full pl-[20px] pr-[10px] py-[5px] w-[300px]"
                        classNameInput="bg-[#f6f7f9] text-[14px]"
                        placeholder="Поиск..." 
                        value={inputValue}
                        ...
                        onClickRightIcon={() => setInputValue("")}
                    />
                    <div className="flex items-center gap-2">
                        <div className="cursor-pointer relative">
                            <Heart size={20} strokeWidth={1} />
                            <div className="absolute top-0 right-0 translate-x-[6px] -translate-y-[4px]">
                                <div className="bg-[#FFF] flex items-center justify-center border border-[#000] text-[12px] font-bold rounded-full w-[15px] h-[15px]">12</div>
                            </div>
                        </div>
                        <div className="cursor-pointer relative">
